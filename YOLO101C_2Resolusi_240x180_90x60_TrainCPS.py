...
with open(filenya, 'w') as out_file:
    ...
    for k_val in range(1,2):
        ...
        conv1tMP_1 = layers.MaxPooling3D(pool_size=(1, 2, 2), strides=None, padding='valid', data_format=None)(conv1t_1)
        ...
        # Layer 1: Just a conventional Conv2D layer
        conv1t_2 = layers.Conv3D(filters=16, kernel_size=(3,5,5), strides=1, padding='valid', activation='relu', name='conv1t_2')(x2)
        conv1tMP_2 = layers.MaxPooling3D(pool_size=(1, 2, 2), strides=None, padding='valid', data_format=None)(conv1t_2)
        ...
        decoder.add(layers.Dense(np.prod(input_shape2)/64, activation='relu'))
        decoder.add(layers.Reshape(target_shape=(32/(RzFaktor),Ry2/8,Rx2/8,3), name='out_recon_unupsized1'))
