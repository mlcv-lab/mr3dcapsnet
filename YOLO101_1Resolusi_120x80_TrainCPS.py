...
with open(filenya, 'w') as out_file:
    ...
    for k_val in range(1,2):
        ...
        conv1t = layers.Conv3D(filters=8, kernel_size=(3,5,5), strides=1, padding='valid', activation='relu', name='conv1t')(x)
        ...
        conv1 = layers.Conv3D(filters=16, kernel_size=(3,5,5), strides=1, padding='valid', activation='relu', name='conv1')(conv1tDO)
        ...
        decoder.add(layers.Dense(np.prod(input_shape)/384, activation='relu'))
        decoder.add(layers.Reshape(target_shape=(52/(RzFaktor),Rx/24,Ry/16,3), name='out_recon_unupsized1'))
        ...
        checkpoint = callbacks.ModelCheckpoint(namafilenya, monitor='val_capsnet_acc',
