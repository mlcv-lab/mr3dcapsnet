...
#    
    ...
    filterSizeXYL1 = 7  #ukuran filter dimensi spasial
    ...
    model.add(Convolution3D(filterNumL2,kernel_dim1=filterSizeTL2, kernel_dim2=5, kernel_dim3=5, activation='relu', dim_ordering='tf'))
