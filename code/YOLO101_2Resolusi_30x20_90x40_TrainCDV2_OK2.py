...
kcv = 1
vartuning = '2Resolusi_30x20_90x60'
...
#    
    ...
    modelB = Convolution3D(filterNumL1,kernel_dim1=5, kernel_dim2=7, kernel_dim3=7, input_shape=(RDepth, R1y, R1x,3), activation='relu', dim_ordering='tf')(modelB_In)
    ...
    modelB = Convolution3D(filterNumL2,kernel_dim1=3, kernel_dim2=5, kernel_dim3=5, activation='relu', dim_ordering='tf')(modelB) 
    # model.add(Convolution3D(filterNumL2,kernel_dim1=1, kernel_dim2=3, kernel_dim3=3, activation='relu', dim_ordering='tf'))
    #model.add(BatchNormalization(epsilon=0.001, axis=-1, momentum=0.99, weights=None, beta_init='zero', gamma_init='one', gamma_regularizer=None, beta_regularizer=None))
    modelB = MaxPooling3D(pool_size=(1, poolingSizeXYL1, poolingSizeTL1), dim_ordering='tf')(modelB)                    
    modelB = SpatialDropout3D(0.3)(modelB)  
    modelB = Convolution3D(128,kernel_dim1=5, kernel_dim2=3, kernel_dim3=3, activation='relu', dim_ordering='tf')(modelB) 
    ...
    modelB = Convolution3D(128,kernel_dim1=3, kernel_dim2=3, kernel_dim3=3, activation='relu', dim_ordering='tf')(modelB) 
    modelB = SpatialDropout3D(0.5)(modelB) 
    
    modelB = Flatten()(modelB)  

    modelA_In = Input(shape=(RDepth, R2y, R2x,3))
    modelA = Convolution3D(filterNumL1,kernel_dim1=3, kernel_dim2=filterSizeXYL1, kernel_dim3=filterSizeXYL1, input_shape=(RDepth, R1y, R1x,3), activation='relu', dim_ordering='tf')(modelA_In)
    #model.add(BatchNormalization(epsilon=0.001, axis=-1, momentum=0.99, weights=None, beta_init='zero', gamma_init='one', gamma_regularizer=None, beta_regularizer=None))
    modelA = MaxPooling3D(pool_size=(2, poolingSizeXYL1, poolingSizeTL1), dim_ordering='tf')(modelA)
    modelA = SpatialDropout3D(0.3)(modelA)
    modelA = Convolution3D(64,kernel_dim1=3, kernel_dim2=3, kernel_dim3=3, activation='relu', dim_ordering='tf')(modelA)
    # model.add(Convolution3D(128,kernel_dim1=1, kernel_dim2=3, kernel_dim3=3, activation='relu', dim_ordering='tf'))
    #model.add(BatchNormalization(epsilon=0.001, axis=-1, momentum=0.99, weights=None, beta_init='zero', gamma_init='one', gamma_regularizer=None, beta_regularizer=None))
    modelA = MaxPooling3D(pool_size=(1, poolingSizeXYL1, poolingSizeTL1), dim_ordering='tf')(modelA)                    
    modelA = SpatialDropout3D(0.5)(modelA)   
    modelA = Convolution3D(128,kernel_dim1=3, kernel_dim2=3, kernel_dim3=3, activation='relu', dim_ordering='tf')(modelA)
    # model.add(Convolution3D(128,kernel_dim1=1, kernel_dim2=3, kernel_dim3=3, activation='relu', dim_ordering='tf'))
    #model.add(BatchNormalization(epsilon=0.001, axis=-1, momentum=0.99, weights=None, beta_init='zero', gamma_init='one', gamma_regularizer=None, beta_regularizer=None))
