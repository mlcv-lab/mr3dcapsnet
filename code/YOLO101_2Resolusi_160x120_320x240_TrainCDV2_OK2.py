...
kcv = 1
vartuning = '2Resolusi_160x120_320x240'
...
#    
    ...
    modelB = Convolution3D(16,kernel_dim1=3, kernel_dim2=5, kernel_dim3=5, input_shape=(RDepth, R1y, R1x,3), activation='relu', dim_ordering='tf')(modelB_In)
    ...
    modelB = SpatialDropout3D(0.3)(modelB)  
    modelB = Convolution3D(128,kernel_dim1=3, kernel_dim2=5, kernel_dim3=5, activation='relu', dim_ordering='tf')(modelB) 
