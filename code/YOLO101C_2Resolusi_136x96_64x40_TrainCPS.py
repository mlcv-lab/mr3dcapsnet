...
# --------------------------------------------- input datanya mnist
import csv
vartuning = '2Resolusi_64x40_136x96'
...
with open(filenya, 'w') as out_file:
    ...
    for k_val in range(1,9):
        ...
        conv1t_1 = layers.Conv3D(filters=16, kernel_size=(3,3,3), strides=1, padding='valid', activation='relu', name='conv1t_1')(x1)
        conv1tMP_1 = layers.MaxPooling3D(pool_size=(2, 2, 2), strides=None, padding='valid', data_format=None)(conv1t_1)
        ...
        conv1_1 = layers.Conv3D(filters=32, kernel_size=(3,3,3), strides=1, padding='valid', activation='relu', name='conv1_1')(conv1tDO_1)
