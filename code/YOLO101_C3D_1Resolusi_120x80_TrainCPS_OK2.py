...
def load_videos(k_val, Rx=168, Ry=112, RzFaktor=8):
...
def PrimaryCap(inputs, dim_capsule, n_channels, kernel_size, strides, padding):
    ...
    """
    outputC = layers.Conv3D(filters=dim_capsule*n_channels, kernel_size=kernel_size, strides=(1,1,1), padding=padding,
...
vartuning = '1Resolusi_171x128'
filenya = 'YOLO_U_VCPS_C3D_' + vartuning + '.csv'
...
with open(filenya, 'w') as out_file:
    ...
    for k_val in range(1,2):
        ...
        primarycaps = PrimaryCap(func_c3d, dim_capsule=16, n_channels=16, kernel_size=(1,3,3), strides=1, padding='valid')
