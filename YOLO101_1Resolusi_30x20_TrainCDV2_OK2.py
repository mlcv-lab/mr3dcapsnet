...
#    
    ...
    model = Sequential()
    model.add(Convolution3D(filterNumL1,kernel_dim1=3, kernel_dim2=filterSizeXYL1, kernel_dim3=filterSizeXYL1, input_shape=(RDepth, R1y, R1x,3), activation='relu', dim_ordering='tf'))
    ...
    model.add(Convolution3D(64,kernel_dim1=3, kernel_dim2=3, kernel_dim3=3, activation='relu', dim_ordering='tf'))
